...
## [0.2.0](https://github.com/yonasBSD/youtui/compare/ytmapi-rs/v0.1.0...ytmapi-rs/v0.2.0) - 2025-10-10
...
### Fixed
- handle new add/remove library icons that broke multiple queries ([#272](https://github.com/yonasBSD/youtui/pull/272))
