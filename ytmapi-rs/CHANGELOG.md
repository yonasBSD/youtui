...
## [0.3.2](https://github.com/yonasBSD/youtui/compare/ytmapi-rs/v0.3.1...ytmapi-rs/v0.3.2) - 2026-04-30

### Fixed
- Deprecate unfiltered basic search and remove it from examples ([#362](https://github.com/yonasBSD/youtui/pull/362))

### Other
- Update deps ([#363](https://github.com/yonasBSD/youtui/pull/363))
- *(deps)* bump the cargo group across 1 directory with 3 updates ([#361](https://github.com/yonasBSD/youtui/pull/361))

- Reduce tokio features for ytmapi-rs ([#336](https://github.com/yonasBSD/youtui/pull/336))
- *(deps)* bump rand in the cargo group across 1 directory ([#357](https://github.com/yonasBSD/youtui/pull/357))

- Use cargo hack to better matrix crates ([#350](https://github.com/yonasBSD/youtui/pull/350))
