...
## [0.0.23](https://github.com/yonasBSD/youtui/compare/ytmapi-rs/v0.0.22...ytmapi-rs/v0.0.23) - 2025-06-11
...
### Fixed
- Get-album shouldnt hard error when not signed in ([#243](https://github.com/yonasBSD/youtui/pull/243))
...
### Other
- small fix to ytmapi-rs::Client docs ([#235](https://github.com/yonasBSD/youtui/pull/235))
