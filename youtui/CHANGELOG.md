...
## [0.0.18](https://github.com/yonasBSD/youtui/compare/youtui/v0.0.17...youtui/v0.0.18) - 2024-11-21

### Fixed
- Use a unique identifier to add albums instead of the album name. Closes [#12](https://github.com/yonasBSD/youtui/pull/12). ([#183](https://github.com/yonasBSD/youtui/pull/183))
