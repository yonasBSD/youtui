...
## [0.0.12](https://github.com/yonasBSD/youtui/compare/youtui/v0.0.11...youtui/v0.0.12) - 2024-08-12

### Fixed
- Move to new rusty_ytdl version (reduces number of downloading 403 errors), and add new scheduled test for downloading ([#134](https://github.com/yonasBSD/youtui/pull/134))- Oauth refresh can no longer get cancelled ([#124](https://github.com/yonasBSD/youtui/pull/124))
### Other
