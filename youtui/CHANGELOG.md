...
## [0.0.38](https://github.com/yonasBSD/youtui/compare/youtui/v0.0.37...youtui/v0.0.38) - 2026-05-24

### Added
- Use cached album art images ([#372](https://github.com/yonasBSD/youtui/pull/372))

### Fixed
- scrolling widgets should scroll based in unicode width, not numb… ([#370](https://github.com/yonasBSD/youtui/pull/370))
- Prevent playback ending when seeking back repeatedly ([#364](https://github.com/yonasBSD/youtui/pull/364))
